...
- [v1 release audit](https://github.com/lindgreendavid/jovian-resonance-lab/blob/main/docs/v1-release-audit.md) — scientific identities, reproduction steps, deviations, and remaining limits.`,
  },
  {
    ...
    body: `**Current research status:** stable product v1.0.1 preserves the frozen v0.1 morphology study and
...
- [v1.0.1 release](https://github.com/lindgreendavid/snowflake-evolution-lab/releases/tag/v1.0.1) — current product and clarified animation semantics; frozen v0.1 and v1.0 evidence remains unchanged.`,
  },
  {
    ...
    body: `**Current research status:** stable product v1.0.0; protocol-frozen computational replication and
